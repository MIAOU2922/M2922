Shader "Hidden/Locked/.poiyomi/Poiyomi Pro Wireframe/2377660e26f11314b96f5e873cbd4ae4"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(1,0,1,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(1,0,1,1).a;
				#else
