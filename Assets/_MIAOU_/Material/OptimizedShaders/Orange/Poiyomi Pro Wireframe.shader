Shader "Hidden/Locked/.poiyomi/Poiyomi Pro Wireframe/4816a026f8034bb479d6870f094383ed"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(1,0.1274377,0,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(1,0.1274377,0,1).a;
				#else
